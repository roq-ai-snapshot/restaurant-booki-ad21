  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Streamlining Your Dining Experience. Book Your Table, Let Us Handle the Rest. Empowering Restaurants to Serve Better."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Streamlining Your Dining Experience. Book Your Table, Let Us Handle the Rest. Empowering Restaurants to Serve Better.`}
            </Text>
            <Box
